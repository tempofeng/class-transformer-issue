...
import {TeamTransaction2} from "../src/TeamTransaction2";
import chai = require("chai");

@suite
class TeamTransaction2Spec {
    constructor() {
        chai.should();
    }
        ...
        const txJson = `
{
                ...
                "from": {"address":"0xea95a7a25506c9F70fB7bC50877C435a609353b2"},
                "to": {"address":"0xf3Ad7a80c7deBE37Db5ceE1E3Ed45f31a5629e5e"}
}`;

        // when convert json to TeamTransaction
        const teamTransaction = plainToClass(TeamTransaction2, JSON.parse(txJson) as TeamTransaction2);
        ...
        JSON.stringify(value).should.be.eq(
            `{"teamId":"6468a5f1-64d7-4a56-9ba5-e4f66a1d8923","from":{"address":"0xea95a7a25506c9F70fB7bC50877C435a609353b2"},"to":{"address":"0xf3Ad7a80c7deBE37Db5ceE1E3Ed45f31a5629e5e"}}`);
    }
}
